...
from accounts.models import MyPollAppUser
...
from mbakop_polls.settings import EMAIL_FROM
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, mark_safe(_('unknown My Poll App User or bad password.')))
    else:
        form = LoginForm()
...
class MbakopUserDetail(DetailView):

    model = MyPollAppUser
    template_name = "accounts/user_detail.html"

    def get_context_data(self, **kwargs):
        context = super(MbakopUserDetail, self).get_context_data(**kwargs)
    ...
    def dispatch(self, *args, **kwargs):
        return super(MbakopUserDetail, self).dispatch(*args, **kwargs)
