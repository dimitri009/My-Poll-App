...
class UserCreationForm(forms.ModelForm):
    ...
    password_confirmation = forms.CharField(widget=forms.PasswordInput(attrs={ 'placeholder': _('Confirm your password'),
                                                                               'autocomplete': 'new-password'}),label=_('Password confirmation *'))
